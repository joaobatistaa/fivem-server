...
CreateThread(function()
    while true do
        ...
        if isCameraActive then
            ...
            DisableControlAction(2, 23, true) -- f
            DisableControlAction(2, 20, true) -- z
            DisableControlAction(2, 29, true) -- b
            DisableControlAction(2, 37, true) -- tab
            DisableControlAction(2, 45, true) -- r
            DisableControlAction(2, 52, true) -- q
            ...
            DisableControlAction(2, 288, true) -- F1
            DisableControlAction(2, 166, true) -- F5
...
CreateThread(function()
    ...
    while true do
        ...
        if isCameraActive then
            sleep = 0
            if IsControlPressed(0, 47) then -- tecla G
                angle = angle - 1
            elseif IsControlPressed(0, 74) then -- tecla H
                angle = angle + 1
            end
