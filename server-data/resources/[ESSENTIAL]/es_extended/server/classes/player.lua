...
function CreateExtendedPlayer(playerId, identifier, license, group, accounts, inventory, weight, job, loadout, name, coords, metadata, vip, steamName)
