function CreateExtendedPlayer(playerId, identifier, license, group, accounts, inventory, weight, job, loadout, name, coords, vip)
	...
	if Config.Multichar then self.license = 'license'.. identifier:sub(identifier:find(':'), identifier:len()) else self.license = license end
	...
	function self.getInventoryItem(name)
		local Item = exports['qs-inventory']:GetItem(self.source, name)
		return Item
	end
