...
function OpenBossMenu(society, close, options)
	...
	if options.deposit then
		...
		--table.insert(elements, {label = 'Retirar Dinheiro Sujo', value = 'withdraw_society_blackmoney'})
		--table.insert(elements, {label = 'Depositar Dinheiro Sujo', value = 'deposit_blackmoney'})
		--table.insert(elements, {label = 'Ver Dinheiro Sujo', value = 'verblack'})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society, {
			...
			if societyInfo then
				ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society, {
					...
					if amount == nil then
						...
						TriggerServerEvent('okokBanking:WithdrawMoneyToSociety', amount, societyInfo.society, societyInfo.society_name, societyInfo.value)
					end
				...
				exports['mythic_notify']:DoHudText('inform', 'A tua empresa ainda não tem conta registada no banco!')
			end
			...
			if societyInfo then
				ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society, {
					...
					if amount == nil then
						...
						TriggerServerEvent('okokBanking:DepositMoneyToSociety', amount, societyInfo.society, societyInfo.society_name)
					end
		...
		elseif data.current.value == 'verblack' then
			TriggerServerEvent('esx_society:verblack', society)
		elseif data.current.value == 'withdraw_society_blackmoney' then
