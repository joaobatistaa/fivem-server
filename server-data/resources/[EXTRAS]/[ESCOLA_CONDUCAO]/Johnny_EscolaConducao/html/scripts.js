...
$(".btnQuestion").click(function () {
	$.post('http://Johnny_EscolaConducao/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://Johnny_EscolaConducao/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://Johnny_EscolaConducao/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
