...
doc.getElementById('exit').addEventListener('mouseover', _ => changeInfo(true, 'exit', 'Fechar o menu de animação.'));
...
doc.getElementById('favorite').addEventListener('mouseover', _ => changeInfo(true, 'favorites', 'Mostre suas animações favoritas.'));
...
doc.getElementById('props').addEventListener('mouseover', _ => changeInfo(true, 'props', 'Mostrar animações de adereços.'));
...
doc.getElementById('cancel').addEventListener('mouseover', _ => changeInfo(true, 'Cancelar', 'Cancele a animação em reprodução atual.'));
...
doc.getElementById('delete').addEventListener('mouseover', _ => changeInfo(true, 'Apagar Objetos', 'Exclui todos os adereços se você os tiver presos a você.'));
...
doc.getElementById('movement').addEventListener('mouseover', _ => changeInfo(true, 'Movimento', 'Permite o movimento durante a reprodução de uma animação (não compartilhado).'));
...
doc.getElementById('loop').addEventListener('mouseover', _ => changeInfo(true, 'Infinito', 'Animação infinita (substitui a duração das animações).'));
