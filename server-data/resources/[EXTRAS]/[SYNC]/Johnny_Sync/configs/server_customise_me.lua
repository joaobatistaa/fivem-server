    ...
    if source and notif_type and message then
        if Config.NotificationType.client == 'esx' then
			if notif_type == 1 then
				TriggerClientEvent('Johnny_Notificacoes:Alert', source, "SUCESSO", "<span style='color:#c7c7c7'>"..message.."", 5000, 'success')
            elseif notif_type == 2 then
				TriggerClientEvent('Johnny_Notificacoes:Alert', source, "INFORMAÇÃO", "<span style='color:#c7c7c7'>"..message.."", 5000, 'info')
            elseif notif_type == 3 then
				TriggerClientEvent('Johnny_Notificacoes:Alert', source, "ERRO", "<span style='color:#c7c7c7'>"..message.."", 5000, 'error')
            end
