Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names. Also dont forget glass cutting and painting item names.(in bottom)
        ...
        {itemName = 'cocaine_packaged', sellPrice = 100},
    },
...
StringsPacific = {
    ['e_start'] = 'Pressiona ~INPUT_CONTEXT~ para iniciar o roubo ao Banco Principal',
    ['start_heist'] = 'Vá para o Banco Principal',
    ['start_heist2'] = 'Itens necessários para o roubo: Portátil, Pen Hack USB, Cortador, Bomba C4, Bomba Térmica, Mala, Broca',
    ['plant'] = 'Pressiona ~INPUT_CONTEXT~ para plantar a bomba térmica',
    ['plant_bomb'] = 'Pressiona ~INPUT_CONTEXT~ para plantar a Bomba C4',
    ['detonate_bombs'] = 'Pressiona ~INPUT_CONTEXT~ para detonar as bombas',
    ['grab'] = 'Pressiona ~INPUT_CONTEXT~ para agarrar',
    ['hacking'] = 'Pressiona ~INPUT_CONTEXT~ para usar a PEN Hack USB',
    ['vault'] = 'Pressiona ~INPUT_CONTEXT~ para abrir o cofre',
    ...
    ['cute_down'] = 'Pressiona ~INPUT_CONTEXT~ para cortar abaixo',
    ['glass_cut'] = 'Pressiona ~INPUT_CONTEXT~ para cortar o vidro',
    ['need_switchblade'] = 'Precisas de uma navalha (Switch_Blade)',
    ['need_this'] = 'Precisas de:',
    ['deliver_to_buyer'] = 'Entrega o que roubaste ao comprador. Verifica o GPS.',
    ['buyer_blip'] = 'Comprador',
    ['need_police'] = 'Não há policias suficientes na cidade',
    ['total_money'] = 'Conseguiste:',
    ['police_alert'] = 'Assalto a decorrer no Banco Principal! Verifica o GPS.',
}
