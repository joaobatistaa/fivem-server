...
Config['FleecaMain'] = {
    ...
    rewardItems = {
        diamondTrolly = { 
            ...
            sellPrice = 1500, -- for buyer sell price
        },
        goldTrolly = { 
            item = 'gold', 
            count = 1,
        ...
        cashTrolly = { 
            item = nil, -- cash
            count = 1000,
            multiGrabCount = 90000, -- middle main grab
        },
        lockbox = function()
...
StringsFleeca = {
	...
	['police_alert'] = 'Assalto a decorrer no banco Fleeca! Verifica o teu GPS.',
	['drill'] = 'Pressiona ~INPUT_CONTEXT~ para usares a broca',
	['grab_trolly'] = 'Pressiona ~INPUT_CONTEXT~ para roubares os itens do carrinho',
	['grab'] = 'Pressiona ~INPUT_CONTEXT~ para roubares o dinheiro',
