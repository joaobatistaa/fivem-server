...
Citizen.CreateThread(function()
    while true do
        ...
        if not isVisible and IsPedInAnyPoliceVehicle(playerPed) and IsControlJustPressed(0, 311) and GetEntitySpeed(playerVeh) < 10.0 then -- letra k
        ...
        elseif IsControlJustPressed(0, 56) and not IsEntityDead(playerPed) then
...
RegisterNetEvent("policia:mdt")
AddEventHandler("policia:mdt", function()
    TriggerServerEvent("mdt:hotKeyOpen")
end)
