    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://Johnny_TabletPolicia/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://Johnny_TabletPolicia/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://Johnny_TabletPolicia/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://Johnny_TabletPolicia/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://Johnny_TabletPolicia/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://Johnny_TabletPolicia/performReportSearch', JSON.stringify({
        ...
        RemoveChargeEdit(offense) {
            for (var key in this.report_edit.data.charges) {
                if (offense == key) {
                    if ((this.report_edit.data.charges[offense] - 1) > 0) {
                        Vue.set(this.report_edit.data.charges, offense, this.report_edit.data.charges[offense] - 1)
                    } else {
                        Vue.delete(this.report_edit.data.charges, offense)
                    }
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://Johnny_TabletPolicia/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://Johnny_TabletPolicia/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://Johnny_TabletPolicia/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://Johnny_TabletPolicia/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
			...
			this.report_selected.charges = this.report_edit.data.charges;
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://Johnny_TabletPolicia/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://Johnny_TabletPolicia/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://Johnny_TabletPolicia/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://Johnny_TabletPolicia/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://Johnny_TabletPolicia/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://Johnny_TabletPolicia/sentencePlayer', JSON.stringify({
