...
infoLojaRoupa.Price = 1000

RegisterServerEvent('esx_eden_clotheshop:pay')
AddEventHandler('esx_eden_clotheshop:pay', function()
	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.removeAccountMoney('money', infoLojaRoupa.Price)

	--TriggerClientEvent('esx:showNotification', source, 'Pagaste 1000€')
	TriggerClientEvent('Johnny_Notificacoes:Alert', source, "COMPRA EFETUADA", "Roupas compradas por <span style='color:#069a19'><b>1000€</b></span>!", 3000, 'success')
end)
