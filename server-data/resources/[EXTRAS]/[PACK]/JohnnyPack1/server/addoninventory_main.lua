...
AddEventHandler('esx:playerLoaded', function(playerId, xPlayer)
	...
	for i=1, #InventoriesIndex, 1 do
		...
		local inventory = GetInventory(name, xPlayer2.identifier)

		if inventory == nil then
			inventory = CreateAddonInventory(name, xPlayer2.identifier, {})
	...
	xPlayer2.set('addonInventories', addonInventories)
end)
