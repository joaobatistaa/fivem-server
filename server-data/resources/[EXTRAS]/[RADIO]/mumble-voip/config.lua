...
mumbleConfig = {
	...
	voiceModes = {
		{4.0, "Sussurrar"}, -- Whisper speech distance in gta distance units
		{8.0, "Normal"}, -- Normal speech distance in gta distance units
		{16.0, "Gritar"}, -- Shout speech distance in gta distance units
	},
	speakerRange = 1, -- Speaker distance in gta distance units (how close you need to be to another player to hear other players on the radio or phone)
	...
	radioChannelNames = { -- Add named radio channels (Defaults to [channel number] MHz)
        [1] = "Transmissão Central 1",
		[2] = "Transmissão Central 2",
		[3] = "Forças de Socorro",
		[4] = "Forças de Socorro",
		[5] = "Forças de Socorro",
		[6] = "Forças de Socorro",
	...
	externalAddress = "51.210.222.114",
	externalPort = 64738,
