...
Config.webhook = "https://discord.com/api/webhooks/1083562839601582112/pPzdUoWPxANVfGaHZdRP7bK2oOT2FNoGkIyoNSwBCTNqiFgGnDHsWMdybL0Dv9Qcqfnb"					-- Webhook to send logs to discord
...
Config.formatacao = {
	['moeda'] = 'EUR',			-- This is the format of the currency, so that your currency sign appears correctly [Examples: BRL, USD]
...
Config.contratos = {
	...
	['cargas'] = {
		...
		{ carga = "armytanker", nome = "Tanque de gás inflamável do exército", def = {2,0,0}},
		{ carga = "armytanker", nome = "Tanque de gás tóxico do exército", def = {5,0,0}},
		{ carga = "armytanker", nome = "Materiais secretos do exército", def = {0,0,1}},

		{ carga = "liquide1", nome = "Hidróxido de potássio", def = {6,0,0}},
		{ carga = "liquide1", nome = "Azoto", def = {2,0,1}},
		{ carga = "liquide1", nome = "Cloreto de Potássio", def = {5,0,0}},
		{ carga = "liquide1", nome = "Cloreto de Potássio", def = {5,0,0}},
		{ carga = "liquide1", nome = "Pesticida", def = {5,0,0}},

		{ carga = "armytrailer", nome = "Reboque vazio do exército", def = {0,0,0}},

		{ carga = "armytrailer2", nome = "Transporte de máquinas pesadas", def = {0,1,1}},
		{ carga = "armytrailer2", nome = "Transporte de máquinas de tunelamento", def = {0,1,1}},
		
		{ carga = "docktrailer", nome = "Transporte de móveis", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de geladeira", def = {0,1,0}},
		...
		{ carga = "docktrailer", nome = "Transporte de cadeira", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de eletrodomésticos", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de material de limpeza", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de madeira refinada", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de pedra", def = {0,0,0}},
		{ carga = "docktrailer", nome = "Transporte de joias", def = {0,1,1}},
		{ carga = "docktrailer", nome = "Transporte de vidro", def = {0,1,0}},
		{ carga = "docktrailer", nome = "Transporte de munição", def = {1,0,0}},
		
		{ carga = "freighttrailer", nome = "Reboque vazio", def = {0,0,0}},

		{ carga = "tr2", nome = "Reboque de carro vazio", def = {0,0,0}},
		
		{ carga = "trailers4", nome = "Reboque de artigos navais", def = {0,0,0}},
		{ carga = "trailers4", nome = "Reboque de barco", def = {0,1,1}},
		
		{ carga = "tr4", nome = "Cegonha", def = {0,1,1}},
		
		{ carga = "tvtrailer", nome = "Transporte de materiais para shows", def = {0,0,1}},
		{ carga = "tvtrailer", nome = "Transporte de materiais do evento", def = {0,1,1}},
		
		{ carga = "tanker", nome = "Depósito de combustível com aditivos", def = {3,0,0}},
		...
		{ carga = "trailerlogs", nome = "Log de transporte", def = {0,0,0}},
		...
		{ carga = "trailers2", nome = "Transporte de uva", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de carne de porco", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de carne bovina", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de cenoura", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de batata", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de leite", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de enlatados", def = {0,0,0}},
		...
		{ carga = "trailers2", nome = "Transporte de água engarrafada", def = {0,0,0}},
		{ carga = "trailers2", nome = "Transporte de queijo", def = {0,0,0}},

		{ carga = "trailers3", nome = "Transporte de ladrilhos", def = {0,0,0}},
		{ carga = "trailers3", nome = "Transporte ferroviário", def = {0,0,0}},
		{ carga = "trailers3", nome = "Transporte de embalagens usadas", def = {0,0,0}},
		{ carga = "trailers3", nome = "Transporte de placa de piso", def = {0,0,0}},
		...
		{ carga = "militaire1", nome = "Transporte de veículos do exército", def = {0,1,1}},
	}
}
...
Config.trabalhos = {
	...
	['valor_inicial_min'] = 100000,			-- Minimum initial contract profit
	['valor_inicial_max'] = 120000,			-- Maximum initial contract profit
...
Config.blips = {
	{1208.7109375,-3114.9431152344,5.7480750083923,478,5,"Logística de Camionistas", 1.1 },
}