function CloseShop() {
    $("#wrapper").html('');
	$("#shopmenu").hide();
    $.post('http://Johnny_Stand/CloseMenu', JSON.stringify({}));
}
...
$(document).ready(function(){
    ...
    $("#body").on('click', ':button', function () {
        ...
        if($(this).data('value') == "buy")
            $.post('http://Johnny_Stand/BuyVehicle', JSON.stringify({model: $(this).data('model')}));
        else if($(this).data('value') == "test-drive")
            $.post('http://Johnny_Stand/TestDrive', JSON.stringify({model: $(this).data('model')}));
    });
