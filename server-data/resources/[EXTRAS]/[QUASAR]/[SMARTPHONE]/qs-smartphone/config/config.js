...
const SpotifyArray = [{ // Don't touch this
    ...
    description: 'Ouça as suas músicas favoritas!',
    thumbnail: 'https://t.scdn.co/images/3099b3803ad9496896c43f22fe9be8c4.png',
    playlists: []
}, // Don't touch this until here
{
    name: 'Pop',
    description: 'A melhor música pop em inglês de 2023 para si!',
...
{
    name: 'Trap',
    description: 'A melhor música trap em inglês de 2023 para si!',
...
{
    name: 'Tech',
    description: 'A melhor música tech em inglês de 2023 para si!',
...
{
    name: 'Synthwave',
    description: 'A melhor música synth em inglês de 2023 para si!',
...
{
    name: 'Dubstep',
    description: 'A melhor música dubs em inglês de 2023 para si!',
