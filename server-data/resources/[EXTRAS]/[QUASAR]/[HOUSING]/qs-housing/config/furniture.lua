...
Config.roomsData = {
    { id = 'living-room', name = 'Sala de Estar' },
    { id = 'kitchen', name = 'Cozinha' },
    { id = 'bathroom', name = 'Casa de Banho' },
...
Config.FurnitureList = {
	...
	["toilet-brushs"] = {
		["label"] = "Escovas de Casa de Banho",
		["items"] = {
