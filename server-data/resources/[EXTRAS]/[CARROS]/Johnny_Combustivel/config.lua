...
Config.Strings = {
	ExitVehicle = "Saia do veiculo para abastecer",
	EToRefuel = "Pressiona ~g~E ~w~para abastecer o veículo",
	JerryCanEmpty = "O Galão de Combustível está vazio",
	FullTank = "O tanque do carro está cheio",
	PurchaseJerryCan = "Pressiona ~g~E ~w~para comprar um Galão de Combustível por ~g~€" .. Config.JerryCanCost,
	CancelFuelingPump = "Pressiona ~g~E ~w~para parar de abastecer",
	CancelFuelingJerryCan = "Pressiona ~g~E ~w~para parar de abastecer",
	NotEnoughCash = "Não tens dinheiro suficiente!",
	RefillJerryCan = "Pressiona ~g~E ~w~ para reabastecer o Galão de Combustível por ",
	NotEnoughCashJerryCan = "Não tens dinheiro suficiente",
	JerryCanFull = "O Galão de Combustível está cheio",
	TotalCost = "Preço",
}
...
Config.GasStations = {
	...
	vector3(5085.41, -4622.69, 2.55) -- ilha
}
