...
RegisterCommand("menuveiculo", function(source, args, rawCommand)
...
RegisterKeyMapping('menuveiculo', 'Abrir Controlo do Veículo', 'keyboard', DefaultOpen)
...
-- FORCE CLOSE
RegisterCommand("fecharmenuveiculo", function(source, args, rawCommand)
	closeVehControl()
end, false)
