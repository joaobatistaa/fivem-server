...
--[[    local cachedStorage = cachedData["storages"][storageId]
   ...
   -- "esx_motel:getInventoryV",
    --function(inventory)
    --    text = storageId
     --   data = {storageId = storageId, max = "", myVeh = "", text = text}
        --TriggerEvent("esx_inventoryhud:openmotelInventory", data, storageId)
  --  end, storageId)
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "motel_"..ESX.GetPlayerData().identifier)
