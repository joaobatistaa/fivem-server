...
Config.MotelPrice = 300000 -- this is the price that you will pay when you buy the motel.
Config.KeyPrice = 20000 -- this is the price for each key that you want to buy.
...
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_DETONATE~ Colocar no chão ~n~"
