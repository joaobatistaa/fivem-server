				...
				if(value.isBeingHelped) {
					row += `
						<tr>
							...
							<td class="text-center align-middle"><button type="button" id="view_report_btn" data-report_index="${index}" class="btn btn-blue btn-view"><i class="fas fa-eye"></i> VER</button></td>
						</tr>
					`;
				} else {
					row += `
